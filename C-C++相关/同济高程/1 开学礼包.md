...
安装 [FileEncoding](https://marketplace.visualstudio.com/items?itemName=genrwoody.FileEncodingVS2022) 插件。安装完成后，右下角会显示当前编码与行尾。**作业提交强制要求编码为 GBK，行尾为 CRLF**，否则当次作业记零分。
