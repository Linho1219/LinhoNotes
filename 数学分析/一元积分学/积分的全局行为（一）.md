...
**结构** 设有$\begin{cases}g(x)在[a,b]上单调递减且非负\\f(x)\in\Re[a,b]\end{cases}$
...
**结构** 设有$\begin{cases}g(x)在[a,b]上单调递增且非负\\f(x)\in\Re[a,b]\end{cases}$
...
**结构** 设有$\begin{cases}g(x)在[a,b]上单调且非负\\f(x)\in\Re[a,b]\end{cases}$
