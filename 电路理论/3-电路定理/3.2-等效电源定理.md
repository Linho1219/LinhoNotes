...
计算电桥中 $R_x$ 分别等于 $0\,\Omega$、$0.8\,\Omega$、$1.6\,\Omega$ 时，该支路的电流和功率。
...
容易看出是 $2\,\Omega$ 和 $3\,\Omega$ 并联，有 $R_i=\dfrac{3\times2}{3+2}=1.2\,\Omega$。
...
$$
\begin{array}{l}
R_x=0\,\Omega&I=\dfrac65\operatorname A&P=0\operatorname W \\
R_x=0.8\,\Omega&I=0.5\operatorname A&P=0.2\operatorname W \\
R_x=1.6\,\Omega&I=\dfrac5{14}\operatorname A&P=\dfrac{10}{49}\operatorname W \\
\end{array}
$$
...
如图所示电路，已知 $R=8\,\Omega$ 时，$I=1\operatorname A$。求 $R$ 为何值时 $I=0.5\operatorname A$？
...
得到 $R_i=22\,\Omega$。有等效电路：

![](./images/eqsrc-exa-2-ana-3.svg)

利用题目条件 $R=8\,\Omega$ 时 $I=1\operatorname A$，故有 $U_{OC}=(22+8)\times1=30\operatorname V$。

故有 $I'=\dfrac{30}{22+R'}=0.5$，解得 $R'=38\,\Omega$。
