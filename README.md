...
本仓库的文档部分采用 [知识共享署名 4.0 许可协议](https://creativecommons.org/licenses/by/4.0/) 进行许可，代码部分采用 [MIT 协议](https://github.com/Linho1219/LinhoNotes/blob/main/.vitepress/LICENSE) 进行许可。
