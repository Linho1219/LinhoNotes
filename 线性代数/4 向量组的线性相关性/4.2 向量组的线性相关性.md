...
$$
k_1\boldsymbol\alpha_1+k_2\boldsymbol\alpha_2+\cdots+k_m\boldsymbol\alpha_m=\bold 0
$$
...
> [!tip]
>
> 等号右边的 $\bold 0$ 是零向量，不是零矩阵 $\boldsymbol O$，也不是数字 $0$。
...
$$
x_1\boldsymbol\alpha_1+x_2\boldsymbol\alpha_2+\cdots+x_m\boldsymbol\alpha_m=\bold 0
$$
