...
一作定轴转动的物体，对转轴的转动惯量 $J=3.0\,{\rm kg\cdot m^2}$，角速度 $\omega_0=6.0\,{\rm rad/s}$。现对物体加一恒定的制动力矩 $M=-12\,{\rm N\cdot m}$，当物体的角速度减慢到 $\omega=2.0\,{\rm rad/s}$ 时，物体已转过了角度 $\Delta\theta=$ $\underline{\hspace{3em}}$。
