...
如图所示，沙子从 $h=0.8\,{\rm m}$ 高处下落到以 $3\,{\rm m/s}$ 的速率水平向右运动的传送带上。则传送带给刚落到传送带上的砂子的作用力的方向为 $\underline{\hspace{3em}}$。
...
一吊车底板上放一质量为 $10\,{\rm kg}$ 的物体，若吊车底板加速上升，加速度大小为 $a=3+5t$，则 $2\,{\rm s}$ 内物体动量的增量大小为 $\underline{\hspace{3em}}$，吊车底板给物体的冲量大小为 $\underline{\hspace{3em}}$。
...
$$
I-mgt =\Delta p\Rightarrow I = 360\,{\rm N\cdot s}
$$
...
哈雷彗星绕太阳的轨道是以太阳为一个焦点的椭圆。它离太阳最近的距离是 $r_1=8.75\times10^{10} \,{\rm m}$，此时它的速率是 $v_1=5.46\times10^4\,{\rm m/s}$。它离太阳最远时的速率是 $v_2=9.08\times10^2\,{\rm m/s}$，这时它离太阳的距离是 $r_2=$ $\underline{\hspace{3em}}$。
...
$$
\vec F\cdot\Delta\vec r =(-3,5,9)\cdot(4,-5,6)= 67\,{\rm J}
$$
...
质点在几个力的作用下，沿着曲线 $\cases{x=t\\y=t^2}$ 运动，其中一个力为 $\vec F=5t\vec j$，则这个力在 $t=1\,{\rm s}$ 到 $t=2\,{\rm s}$ 时间内做的功为 $\underline{\hspace{3em}}$。

---

$$
W =\int_1^25t{\rm d}y =\int_1^25t\cdot2t{\rm d}t =\left.\frac{10}3t^3 \right|_1^2 =\frac{70}3\,{\rm J}
$$
...
有一矩形底孔闸门，高 $h=3\,{\rm m}$，宽 $b=2\,{\rm m}$，上游水深 $h_1=6\,{\rm m}$，下游水深 $h_2=5\,{\rm m}$。水的密
度为 $1.0\times10^3\,{\rm kg/m^3}$，求两侧水作用于闸门上的静压力大小。
...
$$
\begin{align}
F_左&=\int_{h_1-h}^{h_1}\rho gh\cdot b{\rm d}h = 2.7\times10^5\,{\rm N}\\
F_右&=\int_{h_2-h}^{h_2}\rho gh\cdot b{\rm d}h = 2.1\times10^5\,{\rm N}
\end{align}
$$
...
水在平管中做定常流，流量为 $4\times10^3\,{\rm cm^3/s}$，粗处截面积为 $40\,{\rm cm^2}$，细处截面积为 $10\,{\rm cm^2}$。求水在两处的流速和压强差。

---

由 $v_1S_1=v_2S_2=Q$ 解得 $v_1=1\,{\rm m/s}$，$v_2=4\,{\rm m/s}$。
...
\Rightarrow p_2-p_1 =\frac12\rho(v_1^2-v_2^2)= 7.5\,{\rm kPa}
\end{gathered}
$$
...
油的密度为 $0.9\times10^3\,{\rm kg/m^3}$，在粗细均匀管道中，A 处比 B 处高 $5\,{\rm m}$，压强低 $1.2\,{\rm kPa}$，求 $5.0\,{\rm m^3}$ 的油在此过程中的能量损失。

---

由于管道粗细均匀，故流速恒定。

依题意，$\Delta h=5\,{\rm m}$，$\Delta p=-1200\,{\rm kPa}$，根据伯努利方程有

$$
\begin{align}
E_1&=V\left(\frac12\rho v^2+\rho gh_1+p_1\right) \\
E_2&=V\left(\frac12\rho v^2+\rho gh_2+p_2\right) \\
\Delta E&=V(\rho g\Delta h+\Delta p)=-1.65\times10^5\,{\rm J}
\end{align}
$$
