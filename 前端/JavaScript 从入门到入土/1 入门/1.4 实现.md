...
[1.2 JavaScript 的历史](./1.2%20%E5%8E%86%E5%8F%B2.md#%e6%a0%87%e5%87%86%e5%8c%96) 中我们提到了 ECMAScript 标准。尽管 ECMAScript 是一个重要的标准，但它并不是 JavaScript 唯一的部分，当然，也不是唯一被标准化的部分。通常，一个完整的 JavaScript 实现是由以下 3 个不同部分组成的：
...
有关函数的更多内容，我们会在 [2.6 函数 Function](../2 数据/2.6 函数.md) 一节中介绍。
