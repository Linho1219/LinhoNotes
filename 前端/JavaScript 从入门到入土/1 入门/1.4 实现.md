...
[1.2 JavaScript 的历史](./1.2%20%E5%8E%86%E5%8F%B2.md) 中我们提到了 ECMAScript 标准。尽管 ECMAScript 是一个重要的标准，但它并不是 JavaScript 唯一的部分，当然，也不是唯一被标准化的部分。通常，一个完整的 JavaScript 实现是由以下 3 个不同部分组成的：
