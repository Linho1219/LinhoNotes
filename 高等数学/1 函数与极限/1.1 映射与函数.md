...
$$
\eqalign{
  & \sin \alpha \cos \beta  = {1 \over 2} [ {\sin  ( {\alpha  + \beta }  ) + \sin  ( {\alpha  - \beta }  )}  ]  \cr 
  & \cos \alpha \sin \beta  = {1 \over 2} [ {\sin  ( {\alpha  + \beta }  ) - \sin  ( {\alpha  - \beta }  )}  ]  \cr 
  & \cos \alpha \cos \beta  = {1 \over 2} [ {\cos  ( {\alpha  + \beta }  ) + \cos  ( {\alpha  - \beta }  )}  ]  \cr 
  & \sin \alpha \sin \beta  =  - {1 \over 2} [ {\cos  ( {\alpha  + \beta }  ) - \cos  ( {\alpha  - \beta }  )}  ] \cr}
$$

$$
\eqalign{
  & \sin \alpha  + \sin \beta  = 2\sin {{\alpha  + \beta } \over 2}\cos {{\alpha  - \beta } \over 2}  \cr 
  & \sin \alpha  - \sin \beta  = 2\cos {{\alpha  + \beta } \over 2}\sin {{\alpha  - \beta } \over 2}  \cr 
  & \cos \alpha  + \cos \beta  = 2\cos {{\alpha  + \beta } \over 2}\cos {{\alpha  - \beta } \over 2}  \cr 
  & \cos \alpha  - \cos \beta  =  - 2\sin {{\alpha  + \beta } \over 2}\sin {{\alpha  - \beta } \over 2} \cr}
$$
...
$$
\eqalign{
  & \mathop {\lim }\limits_{x \to  + \infty } \arctan x = {\pi  \over 2}  \cr 
  & \mathop {\lim }\limits_{x \to  - \infty } \arctan x =  - {\pi  \over 2} \cr}
$$
结论：
$$
...
$$
\eqalign{
  & \mathop {\lim }\limits_{x \to  + \infty } {\rm{arccot}} x = 0  \cr 
  & \mathop {\lim }\limits_{x \to  - \infty } {\rm{arccot}} x = \pi \cr}
$$
结论：
$$
...
$$
\eqalign{
  & {\rm{sh}}(x + y) = {\rm{sh}}x{\rm{ch}}y + {\rm{ch}}x{\rm{sh}}y  \cr 
  & {\rm{sh}}(x - y) = {\rm{sh}}x{\rm{ch}}y - {\rm{ch}}x{\rm{sh}}y  \cr 
  & {\rm{ch}}(x + y) = {\rm{ch}}x{\rm{ch}}y + {\rm{sh}}x{\rm{sh}}y  \cr 
  & {\rm{ch}}(x - y) = {\rm{ch}}x{\rm{ch}}y - {\rm{sh}}x{\rm{sh}}y \cr}
$$
