...
\def\d{\,{\rm d}}
\begin{align}
&\int x^{n-1}f(ax^n+b)\textcolor{red}\dx
 =\textcolor{red}{\frac1{an}}\int f(ax^n+b)\textcolor{red}{\d(ax^n+b)}\quad\small{(a\ne 0)} \\
&\int f(\sin x)\textcolor{red}{\cos x\dx}=\int f(\sin x)\textcolor{red}{\d\sin x} \\
&\int f(\cos x)\textcolor{red}{\sin x\dx}=-\int f(\cos x)\textcolor{red}{\d\cos x} \\
...
&\int f(\arcsin x)\textcolor{red}{{\rm d}x\over\sqrt{1-x^2}}=\int f(\arcsin x)\textcolor{red}{\d(\arcsin x)}
\end{align}
$$
