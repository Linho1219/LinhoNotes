...
则 $\exist\xi\in(a,b)$，使得 $f(b)-f(a)=f'(\xi)(b-a)$。
...
则有 $g(a)=g(b)=0$。根据罗尔定理，$\exist\xi\in(a,b)$ 使得 $g'(\xi)=0$。
...
$$
\exist\xi\in(a,b),f(b)-f(a)=f'(\xi)(b-a)
$$
故有
$$
...
$$
\exist\xi\in(0,x),f(x)-f(0)=f'(\xi)(x-0)
$$
...
- [x] 在区间端点处的函数值相等，即 $F(a)=F(b)$<br/>
  ...
  $\cases{F(a)=f(b)g(a)-f(a)g(a)-f(a)g(b)+f(a)g(a)=f(b)g(a)-f(a)g(b)\\F(b)=f(b)g(b)-f(a)g(b)-f(b)g(b)+f(a)g(b)=f(b)g(a)-f(a)g(b)}$

因此 $\exist\xi\in(a,b),F'(x)=0$。现在倒着写回去即可。
