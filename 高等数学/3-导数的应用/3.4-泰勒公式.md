...
\sin x&=x-{x^3\over3!}+{x^5\over5!}-{x^7\over7!}+\cdots+{(-1)^nx^{2n+1}\over(2n+1)!}+\begin{cases}R_{2n+1}(x)\\R_{2n+2}(x)\end{cases} \\
\cos x&=1-{x^2\over2!}+{x^4\over4!}-{x^6\over6!}+\cdots+{(-1)^nx^{2n}\over(2n)!}+\begin{cases}R_{2n}(x)\\R_{2n+1}(x)\end{cases} \\
