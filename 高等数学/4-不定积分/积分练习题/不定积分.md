...
&=\frac{\sqrt 2}{6}\ln |\frac{u+\sqrt 2}{u-\sqrt 2}|+\frac{2}{3}\arctan u+C\end{aligned}
$$
...
$$
\int\max \{1, x^2, x^3\}\rm d x =\begin{cases}
x^3, x \geq 1 \\1, -1 < x< 1\\ x^2, x\leq -1\end{cases}
$$
